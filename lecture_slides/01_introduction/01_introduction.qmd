...
<center>**What do you expect to gain from this Data Mining Lab course?**</center>
...
-   **Course Info**:
    ...
    -   [Course Webpage - Supplementary.](https://davi-moreira.github.io/2025F_data_mining_lab_purdue_MGMT173/){target="_blank"}
-   [**Syllabus**](https://davi-moreira.github.io/2025F_data_mining_lab_purdue_MGMT173/){target="_blank"}
...
-   [**Schedule and Materials**](https://davi-moreira.github.io/2025F_data_mining_lab_purdue_MGMT173/schedule.html){target="_blank"}:
    -   Podcast (before class)\
    -   Lecture Slides (before/during class)\
    -   Lecture Video (before/during class)\
    -   scripts/labs (during/after class)\
...
## Motivation: from an opinion and raw data...
