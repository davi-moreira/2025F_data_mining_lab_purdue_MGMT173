...
|---------------|---------------|---------------|----------------------------|
| Week 1 | Syllabus, Logistics, and Introduction to R and RStudio | [slides](/lecture_slides/01_introduction/01_introduction.html){target="_blank"}<br>[podcast TBP](){target="_blank"}<br>[video TBP](){target="_blank"} | \- [**Video**: The NBA Data Scientist](https://www.youtube.com/watch?v=MpLHMKTolVw&list=PLkIselvEzpM5nFf4nu--q2OGccA_0alYO){target="_blank"}<br>- [**Video**: Hans Rosling's 200 Countries, 200 Years](https://www.youtube.com/watch?v=jbkSRLYSojo&list=PLkIselvEzpM5nFf4nu--q2OGccA_0alYO&index=1){target="_blank"}<br>- [**Video**: RStudio is now Posit!](https://www.youtube.com/watch?v=0_UNtwEh7kY){target="_blank"} |
| Week 2 | Data Organization to Data Driven Decisions | [slides](/lecture_slides/02_data_organization_decision/02_data_organization_decision.html){target="_blank"}<br>[podcast TBP](){target="_blank"}<br>[video TBP](){target="_blank"} | \- [**Video**: Relational vs. Non-Relational Databases](https://www.youtube.com/watch?v=E9AgJnsEvG4){target="_blank"} |
